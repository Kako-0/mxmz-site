...
export default function Contato() {
  return (
    <main className="relative min-h-dvh container sm:w-4/5 min-[1920px]:w-9/12 mx-auto px-4 grid gap-16">
      <section className="py-40 pb-16 grid gap-24 lg:grid-cols-3 lg:gap-x-0 xl:gap-48">
      ...
      <section className="grid grid-cols-1gap-8 lg:grid-cols-3 lg:gap-x-0 min-h-[45dvh] lg:grid-rows-[auto_100px_auto]">
        <h1 className="w-40 font-semibold text-lg xl:text-4xl lg:col-span-3 lg:w-[400px]">
